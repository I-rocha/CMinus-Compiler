...
7. fun_decl &rarr; tipo_esp ID ( params ) composto_decl
8. params &rarr; param_lista | void
9. param_lista &rarr; param_lista , param | param
10. param &rarr; tipo_esp ID | tipo_esp ID [ ]
11. composto_decl &rarr; { local_decl statement_lista }
12. param_lista &rarr; param_lista , param | param
13. param &rarr; tipo_esp ID | tipo_esp ID [ ]
14. composto_decl &rarr; { local_decl statement_lista }
15. local_decl &rarr; local_decl var_decl | empty
16. statement_lista &rarr; statement_lista statement | empty
17. statement &rarr; exp_decl | composto_decl | selecao_decl | iteracao_decl | retorno_decl
18. exp_decl &rarr; exp ;| ;
19. selecao_decl &rarr; if ( exp ) statement else_stmt
20. else_stmt &rarr; %prec IFX | else statement
21. else_stmt &rarr; %prec IFX | else statement
22. iteracao_decl &rarr; while ( exp ) statement
23. retorno_decl &rarr; return ; | return exp ;
24. exp &rarr; var = exp | simple_exp
25. var &rarr; ID | ID [ exp ]
26. simple_exp &rarr; soma_exp rel soma_exp | soma_exp
27. rel &rarr; <= | < | > | >= | == | !=
28. soma_exp &rarr; soma_exp soma termo | termo
29. soma &rarr; + | -
30. termo &rarr; termo mult fator | fator
31. mult &rarr; \* | /
32. fator &rarr; ( exp ) | var | act | NUM
33. act &rarr; ID ( args )
34. args &rarr; arg_lista | empty
35. arg_lista &rarr; arg_lista , exp | exp
